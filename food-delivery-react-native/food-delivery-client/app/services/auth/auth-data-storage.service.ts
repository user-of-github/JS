...
import { appStorageService, secureAppStorageService } from '@/services/storage/storage';
...
class AuthDataStorageService {
  public constructor(
    private readonly appStorage: IStorage,
    private readonly secureAppStorage: IStorage
  ) {}
